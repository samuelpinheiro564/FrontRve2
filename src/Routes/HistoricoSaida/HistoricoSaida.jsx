...
import styles from '../HistoricoSaida/historicoSaida.module.css';  
                ...
                <tbody>  
                    {historico.map((item) => (  
                        <tr key={item.id}>  
                            ...
                            <td>  
                                <button onClick={() => handleEdit(item)} className={styles.buttonEditar}>Editar</button>  
